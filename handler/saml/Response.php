...
class SAML2_Response
{
    ...
    public function __construct(DOMElement $xml = NULL)
    {
		...
		for ($node = $xml->firstChild; $node !== NULL; $node = $node->nextSibling) {
			...
			if ($node->localName === 'Assertion' || $node->localName === 'EncryptedAssertion') {
				$this->assertions[] = new Mo_SAML2_Assertion($node);
			}
     ...
     *
     * @return Mo_SAML2_Assertion[]|SAML2_EncryptedAssertion[]
     */
     ...
     *
     * @param Mo_SAML2_Assertion[]|SAML2_EncryptedAssertion[] The assertions.
     */
    ...
    */
    ...
    //     /** @var Mo_SAML2_Assertion|SAML2_EncryptedAssertion $assertion */
