...
class Mo_Gsuite_Constants {
	...
	*/
	...
	const GOOGLE_ACCESS_TOKEN_URL = "https://www.googleapis.com/oauth2/v4/token";
	const GOOGLE_RESOURCE_OWNER_DETAILS_URL = "https://www.googleapis.com/oauth2/v1/userinfo";

	const MO_IDP_ENTITY_ID= 'https://login.xecurify.com/moas';
