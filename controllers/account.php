...
if ( get_mo_gsuite_option( 'mo_gsuite_customer_validation_registration_status' ) == 'MO_OTP_DELIVERED_SUCCESS'
	...
	include MOV_GSUITE_DIR . 'views'.DIRECTORY_SEPARATOR.'account'.DIRECTORY_SEPARATOR.'verify.php';
	...
	include MOV_GSUITE_DIR . 'views'.DIRECTORY_SEPARATOR.'account'.DIRECTORY_SEPARATOR.'login.php';
	...
	$admin_phone  = get_mo_gsuite_option( 'mo_gsuite_customer_validation_transactionId' ) ? get_mo_gsuite_option( 'mo_gsuite_customer_validation_transactionId' ) : "";
	include MOV_GSUITE_DIR . 'views'.DIRECTORY_SEPARATOR.'account'.DIRECTORY_SEPARATOR.'register.php';
} else {
	...
	include MOV_GSUITE_DIR . 'views'.DIRECTORY_SEPARATOR.'account'.DIRECTORY_SEPARATOR.'profile.php';
}