...
if(isset($_REQUEST['action'])&&strcasecmp(sanitize_text_field($_REQUEST['action']),'upload_metadata')==0){
	include MOV_GSUITE_DIR . 'views'.DIRECTORY_SEPARATOR.'saml'.DIRECTORY_SEPARATOR.'saml-upload-metadata.php';
	...
	$upload_metadata_url=admin_url().'admin.php?page=service_provider_saml&tab=save&action=upload_metadata';
...
//Broker Service
	...
	include MOV_GSUITE_DIR . 'views'.DIRECTORY_SEPARATOR.'saml'.DIRECTORY_SEPARATOR.'saml-sp.php';
}