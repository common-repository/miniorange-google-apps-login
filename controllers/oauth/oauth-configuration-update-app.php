...
if (! in_array( $currentappname, $supported_app_list )) {
	$is_other_app = true;
	include MOV_GSUITE_DIR . 'views'.DIRECTORY_SEPARATOR.'oauth'.DIRECTORY_SEPARATOR.'oauth-configuration-update-app-custom.php';
} else {
	include MOV_GSUITE_DIR . 'views'.DIRECTORY_SEPARATOR.'oauth'.DIRECTORY_SEPARATOR.'oauth-configuration-update-app-standard.php';
}
