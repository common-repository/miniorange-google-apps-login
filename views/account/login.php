...
echo '	<form name="f" method="post" action="">
			...
			<div class="mo_registration_divided_layout">
				<div class="mo_gsuite_registration_table_layout">
					...
					<p><b>' . mo_gsuite_( "It seems you already have an account with miniOrange. Please enter your miniOrange email and password." ) . '</td><a href="'.esc_url_raw(Mo_Gsuite_Constants::HOSTNAME).'/moas/idp/resetpassword" target="_blank"> ' . mo_gsuite_( "Click here if you forgot your password?" ) . '</a></b></p>
