...
include_once( MOV_GSUITE_DIR . 'views'.DIRECTORY_SEPARATOR.'saml'.DIRECTORY_SEPARATOR.'saml-cloud-broker.php' );
...
<tr>
    <td colspan="2">
        ...
        <br/><br/>
        <input type="checkbox"  onchange="window.location='<?php echo admin_url(); ?>admin.php?page=service_provider_saml'"/>
