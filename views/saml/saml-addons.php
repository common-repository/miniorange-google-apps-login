<?php 
?>
<div style="background-color:#FFFFFF; border:1px solid #CCCCCC; padding:0px 2% 0px 2%; margin-top:5px;">
            <h3><b>SAML 2.0 Plugin Add-ons</h3>
        <hr>
        <p style="font-weight: normal;">Along with the SSO plugin we provide the following add-ons. These add-ons can be purchased separately with all the licensing plans. For more details of the licensing plans, <a href="admin.php?page=gsuitepricing"><b>CLICK HERE</b></a></p>
