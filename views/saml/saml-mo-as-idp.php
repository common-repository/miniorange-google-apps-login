...
<div class="mo_registration_divided_layout">
    ...
    <div class="mo_gsuite_registration_table_layout">
        ...
        <?php include_once( MOV_GSUITE_DIR . 'views'.DIRECTORY_SEPARATOR.'saml'.DIRECTORY_SEPARATOR.'saml-cloud-broker.php' ); ?>
        <p>
        ...
        <table border="1"
            ...
            <tr>
				...
				<?php if ( get_option( 'mo_saml_enable_cloud_broker' ) == 'true' && mo_saml_Mo_GSuite_Utility::micr_saml() ) { ?>
                    <td style="width:60%; padding: 15px;">https://login.xecurify.com/moas</td>
				<?php } else { ?>
            ...
            <tr>
				...
				<?php if ( get_option( 'mo_saml_enable_cloud_broker' ) == 'true' && mo_saml_Mo_GSuite_Utility::micr_saml() ){ ?>
                    <td style="width:60%;  padding: 15px;">https://login.xecurify.com/moas/rest/saml/acs
                    </td>
				<?php }else{ ?>
