...
class Mo_OAuth_Client_Admin_Licensing {
    ...
    public static function show_licensing_page(){
        self::emit_css();
		$regi = mo_go_is_cust_regi();

        ?>
        <!-- Important JSForms -->
        <input type="hidden" value="<?php echo $regi; ?>" id="mo_customer_registered">
        ...
        <!-- End Licensing Table -->
        <a  id="mobacktoaccountsetup" style="display:none;" href="<?php echo add_query_arg( array( 'page' => 'galoginaccount' ), htmlentities( $_SERVER['REQUEST_URI'] ) ); ?>">Back</a>
        <!-- JSForms Controllers -->
        <script>
