...
echo '<h2>Login Transactions Report</h2>
			<div class="mo_oauth_client_small_layout hidden">	
				<div style="float:right;margin-top:10px">
					<input type="submit" ' . esc_html($disabled) . ' name="printcsv" style="width:100px;" value="Print PDF" class="button button-success button-large">
					<input type="submit" ' . esc_html($disabled) . ' name="printpdf" style="width:100px;" value="Print CSV" class="button button-success button-large">
				</div>
				...
				<form id="mo_oauth_client_advanced_reports" method="post" action="">
					...
					<tr>
					<td width="33%">WordPress Username : <input class="mo_oauth_client_table_textbox" type="text" ' . esc_html($disabled) . ' name="username" required="" placeholder="Search by username" value=""></td>
					...
					<td width="33%">Status : <select ' . esc_html($disabled) . ' name="status" style="width:100%;">
					...
					<tr><td><br></td></tr>
					<tr>
					<td width="33%">User Action : <select ' . esc_html($disabled) . ' name="action" style="width:100%;">
						  <option value="login" selected="">User Login</option>
						  <option value="register">User Registeration</option>
						</select>
					</td>
					<td width="33%">From Date : <input ' . esc_html($disabled) . ' class="mo_oauth_client_table_textbox" type="date"  name="fromdate"></td>
					<td width="33%">To Date :<input ' . esc_html($disabled) . ' class="mo_oauth_client_table_textbox" type="date"  name="todate"></td>
					</tr>
					</table>
					<br><input type="submit" ' . esc_html($disabled) . ' name="Search" style="width:100px;" value="Search" class="button button-primary button-large">
				</form>
				<br>
			</div>
