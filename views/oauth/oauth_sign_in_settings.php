...
<div class="mo_table_layout">
		...
		<ol>
			...
			<li>Select <b>"Login with OAuth"</b>. Drag and drop to your favourite location and save.</li>
		</ol>

		<h4>Option 2: Use a Shortcode <small class=""><a href="admin.php?page=gsuitepricing" target="_blank" rel="noopener noreferrer">[STANDARD]</a></small></h4>
		<ul>
	...
	<div class="mo_table_layout ">
		...
		<ul class="mo_premium_features_notice">
			<li>Custom redirect URL is available in <a href="admin.php?page=gsuitepricing" target="_blank" rel="noopener noreferrer">Standard</a> version and above.</li>
			<li>Dynamic Callback URL, Single Login Flow and User Analytics are available in the <a href="admin.php?page=gsuitepricing" target="_blank" rel="noopener noreferrer">Enterprise</a> version.</li>
			<li>Other features are available in the <a href="admin.php?page=gsuitepricing" target="_blank" rel="noopener noreferrer">Premium</a> version and above.</li>
		</ul>
