			...
			<p>' . mo_gsuite_( "Need any help? Just send us a query so we can help you." ) . '</p>
				<form name="f" method="post" action="">
					...
					<table class="mo_registration_settings_table">
						<tr><td>
							<input type="email" class="mo_registration_table_textbox" id="query_email" name="query_email" value="' . esc_html($email) . '" 
								placeholder="' . mo_gsuite_( "Enter your Email" ) . '" required />
							</td>
						</tr>
						<tr><td>
							<input type="text" class="mo_registration_table_textbox" name="query_phone" id="query_phone" value="' . esc_html($phone) . '" 
